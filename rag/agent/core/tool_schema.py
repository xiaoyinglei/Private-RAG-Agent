...
class AgentMessageAssembler:
    ...
    def _identity_and_behavior_section(definition: Any) -> SystemPromptSection:
        ...
        parts.append(
            ...
            "answerable from the current conversation, finish directly without "
            "calling tools.\n\n"
    ...
    def _tool_contract_section(
        ...
        *,
        ...
        content = (
            ...
            "Tool discovery:\n"
            "- If the task can be answered directly, do not call tool_search "
            "just to look for a tool.\n"
            ...
            "complete answer. Preserve citations when you used evidence.\n"
