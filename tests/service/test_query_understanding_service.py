...
@pytest.mark.parametrize(
    ...
    [
        ("这个项目做什么？", "lookup"),
        ("第2页讲了什么风险？", "single_doc_qa"),
        ("讲系统分层的那一部分在哪一节？", "single_doc_qa"),
        ("总结一下这个系统的核心能力。", "synthesis"),
        ("这个系统的处理流程是怎样的？", "research"),
        ("比较 Alpha 和 Beta 的检索链路差异。", "comparison"),
    ],
)
def test_query_understanding_service_classifies_task_types(query: str, task_type: str) -> None:
