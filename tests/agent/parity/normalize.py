...
def normalize_legacy_state(
    ...
    *,
    ...
    """Return the stable, behaviorally relevant portion of a legacy graph state."""
    ...
    normalized: dict[str, object] = {
        ...
        "groundedness_flag": bool(state.get("groundedness_flag", False)),
        ...
        "satisfied_requirements": list(
            state.get("satisfied_requirements", [])
        ),
        "open_gap_ids": [
            getattr(gap, "gap_id", str(gap))
