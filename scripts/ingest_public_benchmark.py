...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--chat-provider", default=None, choices=["ollama", "openai-compatible"])
    ...
    parser.add_argument("--summary-provider", default=None, choices=["ollama", "openai-compatible", "none"])
